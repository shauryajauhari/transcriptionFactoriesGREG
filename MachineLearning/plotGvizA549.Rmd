...
a549gregChr21 <- a549greg[a549greg$chr=="chr21" & a549greg$Class=="Non-Hub", ] ## subset of data for exemplifying
```

## Plotting Data

```{r}
annotationTrackChr21 <- AnnotationTrack(range = a549gregChr21, name = "Non-Hubs", genome = "hg38", chromosome = "chr21")
itrack <- IdeogramTrack(genome = "hg38", chromosome = "chr21")
gtrack <- GenomeAxisTrack()
plotTracks(list(annotationTrackChr21, itrack, gtrack))
```
