...
{
  LRregions[[i]] <- read.table(paste0("./results/H1ESC/LR-hubs/",paste0(eval(parse(text="files[i]")),".bed")), sep = "\t")
...
write.table(LRregionsAll, file = "./GREG/H1_hESC/H1ESCLRs.txt" , row.names = FALSE, col.names = TRUE) ## Save file

LRregionsAll <- toGRanges(LRregionsAll) ## converting to a GRanges object.


## Epigenome marks for H1_hESC cell line

ctcf <- read.table("./GREG/H1_hESC/CTCF/normalizedReads.bedGraph.bedClipped.sorted")
ep300 <- read.table("./GREG/H1_hESC/EP300/normalizedReads.bedGraph.bedClipped.sorted")
h3k4me1 <- read.table("./GREG/H1_hESC/H3K4me1/normalizedReads.bedGraph.bedClipped.sorted")
h3k4me2 <- read.table("./GREG/H1_hESC/H3K4me2/normalizedReads.bedGraph.bedClipped.sorted")
h3k4me3 <- read.table("./GREG/H1_hESC/H3K4me3/normalizedReads.bedGraph.bedClipped.sorted")
h3k9ac <- read.table("./GREG/H1_hESC/H3K9ac/normalizedReads.bedGraph.bedClipped.sorted")
h3k9me3 <- read.table("./GREG/H1_hESC/H3K9me3/normalizedReads.bedGraph.bedClipped.sorted")
h3k27me3 <- read.table("./GREG/H1_hESC/H3K27me3/normalizedReads.bedGraph.bedClipped.sorted")
h3k36me3 <- read.table("./GREG/H1_hESC/H3K36me3/normalizedReads.bedGraph.bedClipped.sorted")
